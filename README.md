Here you see how I learn JavaScript

My learningplan(made from ai):
  Javascript Lernplan 
Woche 1 
...
var ignorierst du vorerst; das ist veraltet. 
cancode
let-und-const-in-javascript)
 (https://www.cancode.de/blog-article/die-eigenheiten-von-var
...
Video‑Beispiel: „JavaScript Tutorial für Anfänger – Teil 2: Variablen“ (YouTube, deutsch). 
(https://www.youtube.com/watch?v=Yj05-Ncn3zk)
youtube
2. Datentypen
Was ist das?
number: 5, -3, 3.14
...
JavaScript ist dynamisch typisiert: Eine Variable kann erst eine Zahl, dann einen Text enthalten. Wichtig: Du solltest
trotzdem verstehen, welchen Typ du gerade nutzt. 
youtube
 (https://www.youtube.com/watch?v=_0GsSJX74e0)
Suchbegriffe
...
Video: „if else – JavaScript Tutorial für Anfänger“ (deutsch). 
then-else.html)
mediaevent
 (https://www.mediaevent.de/javascript/if
5. console.log() – dein
Entwickler‑Fenster
Was ist das?
...
Video: „JavaScript Funktionen – einfach erklärt“ (deutsch). 
starten.de/javascript-kurs-details/)
...
Nützlich, wenn du nicht von vornherein weißt, wie viele Schritte nötig sind (z.B. „solange Nutzer nicht „q“ eingegeben
hat“).
Suchbegriffe
...
Arrays sind die Basis für komplexere Strukturen (z.B. Nutzerliste, Fragenliste, Highscores). 
(https://www.youtube.com/watch?v=1y0X1s4csWI)
youtube
1. Arrays
Was ist das?
...
Woche 4 – DOM‑Grundlagen
(erste Interaktion mit der
Seite)
Was du in dieser Woche lernst
...
Damit machst du deinen HTML‑Seiten das erste Mal „lebendig“. 
v=8J8csC92L2c)
youtube
...
Formulare sind die Schnittstelle zwischen Nutzer und Code. Hier lernst du, wie du Eingaben kontrollierst.
programmieren-starten
 (https://programmieren-starten.de/javascript-kurs-details/)
...
Woche 7 – Echte To‑Do‑Liste
(mit DOM)
Was du in dieser Woche lernst
Dynamisch DOM‑Elemente erstellen (createElement, appendChild)
Liste von To‑Dos im DOM anzeigen
Status ändern (done/not done)
To‑Do‑Listen sind ein klassisches Übungs‑Projekt, das alle vorherigen Themen miteinander verbindet. 
(https://www.youtube.com/watch?v=1y0X1s4csWI)
youtube
...
3. Praktische Aufteil_DGRAMlche
Aufteilung Woche 7
